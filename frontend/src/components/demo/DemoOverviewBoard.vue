    ...
    <section class="bottom-strip">
      ...
      <article class="ops-panel security-panel">
        ...
        <div class="security-list">
          <button v-for="event in securityEvents" :key="event.id" type="button" class="security-item" :title="event.detail" @click="openSecurityEvent(event)">
